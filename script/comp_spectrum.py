...
# STFTして振幅スペクトルを抽出
spectrum1 = np.abs(librosa.stft(x1))
spectrum2 = np.abs(librosa.stft(x2))
spectrum3 = np.abs(librosa.stft(x3))
spectrum4 = np.abs(librosa.stft(x4))
spectrum5 = np.abs(librosa.stft(x5))
...
ac1, wp1 = librosa.core.dtw(spectrum1, spectrum1)
ac2, wp2 = librosa.core.dtw(spectrum1, spectrum2)
ac3, wp3 = librosa.core.dtw(spectrum1, spectrum3)
ac4, wp4 = librosa.core.dtw(spectrum1, spectrum4)
ac5, wp5 = librosa.core.dtw(spectrum1, spectrum5)
