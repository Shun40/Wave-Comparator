...
print("#1 elapsed time:", round(end - start, 4))

# (2) 特徴抽出
print("#2 Feature extraction")
start = time.time()

centroid1 = librosa.feature.spectral_centroid(x1, fs1)
centroid2 = librosa.feature.spectral_centroid(x2, fs2)
centroid3 = librosa.feature.spectral_centroid(x3, fs3)
centroid4 = librosa.feature.spectral_centroid(x4, fs4)
centroid5 = librosa.feature.spectral_centroid(x5, fs5)

end = time.time()
print("#2 elapsed time:", round(end - start, 4))

# (3) 類似度計算
print("#3 Evaluation")
start = time.time()

ac1, wp1 = librosa.core.dtw(centroid1, centroid1)
ac2, wp2 = librosa.core.dtw(centroid1, centroid2)
ac3, wp3 = librosa.core.dtw(centroid1, centroid3)
ac4, wp4 = librosa.core.dtw(centroid1, centroid4)
ac5, wp5 = librosa.core.dtw(centroid1, centroid5)
...
print("#3 elapsed time:", round(end - start, 4))
